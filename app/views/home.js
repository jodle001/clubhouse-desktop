...
const Home = {
  ...
  template: `
		...
		<div v-if="shouldLogout" class="d-flex align-items-center justify-content-center flex-column" style="position:fixed;top:0;left:0;right:0;bottom:0;width:100vw;height:100vh">
			<p>Your access token has expired. To use the app logout and re-login.</p>
